...
# 상사의 공유리더십이 조직구성원들의 직무몰입에 미치는 영향을 연구하기 위해서 421개의 설문문항을 분석하려고 한다. 
# 단순회귀분석 활용하여 인과관계를 검증하라. (data>과제파일>1.단순회귀분석 과제.sav)
...
df.a <- read_spss("1. 단순회귀분석 과제.sav")
str(df.a)
...
# R² = 79.256 / 169.585 (= 79.256 + 90.329) = 0.4673527
...
# Y(직무몰입도) = 0.87519 + 0.73663X(공유리더십)
# t=6.15 이고 p=0.001 으로 귀무가설은 기각되고 연구가설은 지지된다. 따라서 공유리더십은 직무몰입도에 정의 영향을 미친다고
# 볼 수 있다.
# t=0.73663/0.03842 = 19.17309
